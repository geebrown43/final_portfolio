...
handleScroll() {
  if(document.documentElement.scrollTop > 280 && document.documentElement.scrollTop < 330 ){
    this.setState({className: 'show'})
  } else if(document.documentElement.scrollTop > 400 && document.documentElement.scrollTop < 430){
